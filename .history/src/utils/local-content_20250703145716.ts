...
export function allContent() {
    ...
    // Resolve references - this will modify the objects in place
    ...
    if (process.env.NODE_ENV === 'development') {
        ...
        console.log('Header object details:', siteConfig?.header);
        console.log('Footer object details:', siteConfig?.footer);
    }
