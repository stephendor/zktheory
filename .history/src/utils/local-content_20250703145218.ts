...
export function allContent() {
    ...
    // Debug logging to understand the fileToContent mapping
    if (process.env.NODE_ENV === 'development') {
        console.log('Site config before resolving references:', {
            header: siteConfig?.header,
            footer: siteConfig?.footer
        });
        console.log('Available fileToContent keys:', Object.keys(fileToContent));
        console.log('Header file in map:', !!fileToContent['content/data/header.json']);
        console.log('Footer file in map:', !!fileToContent['content/data/footer.json']);
    }
    ...
    if (process.env.NODE_ENV === 'development') {
        console.log('Site config after resolveReferences:', {
