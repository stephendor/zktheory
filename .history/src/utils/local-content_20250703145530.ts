...
export function allContent() {
    ...
    // Create deep copies to avoid mutations affecting the fileToContent map
    ...
    // Use the copies for reference resolution
    objectsCopy.forEach((e) => resolveReferences(e, fileToContent));
    ...
    return { objects: objectsCopy, pages, props: { site: objectsCopy.find((e) => e.__metadata.modelName === Config.name) } };
}
