...
export function getAllPosts(objects) {
    return objects.filter((object) => {
        return object.__metadata?.modelName === 'PostLayout' && 
               object.__metadata?.relativeFilePath?.includes('pages/blog/') &&
               !object.__metadata?.relativeFilePath?.includes('pages/blog/index.md');
    });
}
