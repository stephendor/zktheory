    ...
    return (
        <Html lang="en">
            <Head>
                ...
                {/* SageCell for Interactive Mathematics */}
            ...
            <body>
              ...
              // Initialize SageCell when the page loads
              window.addEventListener('DOMContentLoaded', function() {
                setTimeout(function() {
                  console.log('Initializing SageCell...');
                  try {
                    if (typeof sagecell !== 'undefined') {
                      sagecell.makeSagecell({
                        inputLocation: '#sagecell-cayley-explorer',
                        autoeval: false,
                        evalButtonText: 'Run Interactive Explorer',
                        hide: ['editor', 'permalink'],
                        replaceOutput: true,
                        editor: 'codemirror-readonly'
                      });
                      console.log('SageCell initialized successfully');
                    } else {
                      console.warn('SageCell library not loaded');
                    }
                  } catch (error) {
                    console.error('SageCell initialization failed:', error);
                  }
                }, 1500);
              });
            `
