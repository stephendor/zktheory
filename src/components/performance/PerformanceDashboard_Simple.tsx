  ...
  try {
      ...
      <div className="performance-dashboard bg-gray-900 text-white p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-blue-400">Performance Dashboard</h1>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div>
                ...
                <span className="ml-2 font-medium text-gray-200">
                  {Object.keys(summary.byCategory).join(', ') || 'None'}
                </span>
              </div>
              <div>
                <span className="text-gray-400">Components:</span>
                <span className="ml-2 font-medium text-gray-200">
                  {Object.keys(summary.byComponent).join(', ') || 'None'}
                </span>
              </div>
            </div>
          </div>
    ...
    return (
      <div className="performance-dashboard bg-red-900 text-white p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl font-bold text-red-400">Performance Dashboard Error</h1>
