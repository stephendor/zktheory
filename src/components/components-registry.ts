...
const components = {
    ...
    CodeBlock: dynamic(() => import('./blocks/CodeBlock')),
    ...
    SearchSection: dynamic(() => import('./sections/SearchSection')),
    ...
    TriplePathHeroSection: dynamic(() => import('./sections/TriplePathHeroSection')),
